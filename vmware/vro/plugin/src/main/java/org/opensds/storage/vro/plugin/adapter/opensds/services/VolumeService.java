...
public class VolumeService {
	...
	public String createAndAttachVolume(OpenSDSInfo openSDSInfo, String name, String description, long capacity, String profile,String hostIP,String iqn) throws Exception
	{
		OpenSDS opensds = new OpenSDS();
		opensds.login(openSDSInfo);
		VolumeMO volume = opensds.createVolume(name, description, capacity, profile);
		TimeUnit.SECONDS.sleep(10);
		ConnectMO connect=new ConnectMO("attach", HOST_OS_TYPE.ESXI, iqn, hostIP, null, ATTACH_MODE.RW, ATTACH_PROTOCOL.ISCSI);
